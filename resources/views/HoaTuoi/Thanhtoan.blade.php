...
<ul class="progressbar text-center" style="margin-top:20px ">
    ...
    <span>Vui lòng chọn hình thức thanh toán cho đơn hàng</span>
    <div style="float: left;width: 70%;margin-top: 30px">              
         <div class="nn-product-box-actions text-center" style="float: left;">
            <a role="button" class="btn-default nn-color-white" href="{{action('HoaTuoiController@Camon')}}">
                        <span><b style="color:white">Thanh toán khi nhận hàng</b></span>
            </a>
        </div> 
        <div class="nn-product-box-actions text-center" style="float: left;margin-left: 15px">
            <a role="button" class="btn-default nn-color-white" href="{{action('PaymentOnlineController@do')}}">
                        <span><b style="color:white">Thanh toán Online</b></span>
            </a>
        </div>          
    </div>  
